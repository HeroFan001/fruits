const fruits = [
  {
    id: 1,
    name: "Narancs",
    image: "/img/narancs.jpg",
    descr: `A narancs vagy édes narancs (Citrus sinensis), népies neve auranci, oránzs déligyümölcs a
  ...
  },
  {
    ...
    name: "Lime",
    image: "/img/lime2.jpg",
    descr: `A lime (ejtsd: lájm), savanyú citrom vagy zöldcitrom (Citrus aurantiifolia) ázsiai eredetű, a
  ...
  },
  {
    ...
    descr: `A grépfrút (Citrus x paradisi), angolos írásmód szerint grapefruit, más néven citrancs a citrusformák
  ...
  },
  {
    id: 4,
    name: "Citrom",
    image: "/img/citrom.jpg",
    descr: `A citrom, más néven közönséges citrom, valódi citrom vagy európai citrom[1] (Citrus × limon) a
  ...
  },
  {
    ...
    descr: `A pomelo vagy pummelo (avagy középső gyümölcs) (latin: Citrus grandis, binomiális név: Citrus maxima)
  ...
  },
  {
    ...
    descr: `A mandarin (Citrus reticulata) a citrusformák közé tartozó déligyümölcs. Dél-Kínából származik,
